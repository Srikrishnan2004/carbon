...
export function getEnv(
  ...
  const hardcodedEnv: Record<string, string> = {
    ...
    NOVU_APPLICATION_ID: "local_dev_placeholder_novu_app_id",
    NOVU_SECRET_KEY: "local_dev_placeholder_novu_secret",
    POSTHOG_API_HOST: "https://us.posthog.com",
    POSTHOG_PROJECT_PUBLIC_KEY: "local_dev_placeholder_posthog_key",
    RESEND_API_KEY: "local_dev_placeholder_resend_api_key",
    ...
    STRIPE_SECRET_KEY: "local_dev_placeholder_stripe_secret_key",
    STRIPE_WEBHOOK_SECRET: "local_dev_placeholder_stripe_webhook_secret",
    SUPABASE_ANON_KEY: "local_dev_placeholder_supabase_anon_key",
    SUPABASE_SERVICE_ROLE_KEY:
      "local_dev_placeholder_supabase_service_role_key",
    SUPABASE_URL: "http://127.0.0.1:54321",
    TRIGGER_API_KEY: "local_dev_placeholder_trigger_api_key",
    TRIGGER_API_URL: "https://api.trigger.dev",
    TRIGGER_PROJECT_ID: "local_dev_placeholder_trigger_project_id",
    TRIGGER_PUBLIC_API_KEY: "pk_dev_placeholder_for_local_dev",
    UPSTASH_REDIS_REST_URL: "local_dev_placeholder_redis_url",
    UPSTASH_REDIS_REST_TOKEN: "local_dev_placeholder_redis_token",
