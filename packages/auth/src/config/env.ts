...
export function getEnv(
  ...
  const hardcodedEnv: Record<string, string> = {
    ...
    SUPABASE_ANON_KEY:
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im14dWh5YW5mdWZ0YWhhZWl2dGt2Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTUyNDc0NzgsImV4cCI6MjA3MDgyMzQ3OH0.cfI9eAOV0Tw8FGMBBo1e6KjhpxWOY7dynIQEANkee-0",
    SUPABASE_SERVICE_ROLE_KEY:
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im14dWh5YW5mdWZ0YWhhZWl2dGt2Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc1NTI0NzQ3OCwiZXhwIjoyMDcwODIzNDc4fQ.LJi1SlW5hHnSZC6w4mOy1jNImyVgE0463XTXSLZTy2c",
    SUPABASE_URL: "https://mxuhyanfuftahaeivtkv.supabase.co",
